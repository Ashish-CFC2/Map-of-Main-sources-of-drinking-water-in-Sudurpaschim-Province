...
var style_Sudurpaschim_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Total_popu");
    var labelText = "";
    size = 0;
    ...
    if (value >= 133310.000000 && value <= 139170.400000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 139170.400000 && value <= 192234.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 192234.200000 && value <= 224047.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 224047.800000 && value <= 350797.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 350797.000000 && value <= 904666.000000) {
            style = [ new ol.style.Style({

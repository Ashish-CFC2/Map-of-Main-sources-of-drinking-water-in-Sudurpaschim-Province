...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Web Map of Sudurpaschim on the topic of Main source of drinking water</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1099 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This study presents the development and implementation of a web-based map showcasing the population distribution in Sudurpaschim Province, Nepal, with a focus on the primary sources of drinking water. Utilizing Geographic Information Systems (GIS) and web mapping technologies, the project integrates demographic data with hydrological information to offer an interactive visualization platform. The map highlights the spatial variability in water source reliance, categorizing areas based on the predominant drinking water sources such as rivers, wells, and piped supplies. This tool aims to support regional planning and resource management by providing stakeholders with accessible and up-to-date information. The web map serves as a vital resource for policy-makers, researchers, and local communities, facilitating informed decision-making to address water security and public health concerns in the province. The project underscores the importance of integrating diverse data sets in geospatial platforms to enhance the understanding and management of critical resources in developing regions.';
            }
